...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("vagutier/ipinfo")
    client.subscribe("vagutier/date")
    client.subscribe("vagutier/time")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("vagutier/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("vagutier/date", on_message_from_date)
    client.message_callback_add("vagutier/time", on_message_from_time)
...
def on_message_from_date(client, userdata, msg):
    # print("Custom callback  - topic: "+msg.payload.decode())
    print("Custom callback - Date Message: "+msg.payload.decode())

def on_message_from_time(client, userdata, msg):
    # print("Custom callback  - topic: "+msg.payload.decode())
    print("Custom callback - Time Message: "+msg.payload.decode())
